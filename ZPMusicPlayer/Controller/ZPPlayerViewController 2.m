...
//    [manager GET:@"http://mobile.ximalaya.com/mobile/others/ca/album/track/3045425/true/1/20?device=iPhone" parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
//        
...
- (void)startPlayingMusic{
    ...
    //设置播放按钮
    //self.playOrPause.selected = [ZPPlayer shareSingleton].isPlaying;
...
-(void)updateProgressInfo {
    self.currentTimeLabel.text = [self stringWithTime:[ZPPlayer shareSingleton].currentTime];
//    int value = (int)[ZPPlayer shareSingleton].currentTime / (int)[ZPPlayer shareSingleton].duration;
